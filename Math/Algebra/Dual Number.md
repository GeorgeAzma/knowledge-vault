...
- $\cancel{\epsilon^{-2},\epsilon^{-3},\dots}$
...
- $\text{Im}_\epsilon[f(x+\epsilon)]$ extracts $\epsilon$ part, which is the derivative `Im is usually used for extracting imaginary part`
