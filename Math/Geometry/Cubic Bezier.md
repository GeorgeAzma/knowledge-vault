...
### Highest Point $\operatorname{clamp}(\dfrac{-A.y+2B.y-C.y\pm\sqrt{B.y^{2}-D.yB.y-B.yC.y+D.yA.y+C.y^{2}-A.yC.y}}{D.y-A.y+3B.y-3C.y},0,1)$
> [!note] Reverse sign for lowest point 
> Cubic beziers can have 2 valleys with 0 derivative, unlike quadratic
### From [[Quadratic Bezier|Quadratic]] $C_1=\dfrac{2B}{3},C_2=\dfrac{C+2B}{3}$
