...
### Angle Formulas
- $\tan\theta=\left|\dfrac{A_1B_2-A_2B_1}{A_1A_2+B_1B_2}\right|=\left|\dfrac{k_1-k_2}{1+k_1k_2}\right|=\dfrac{|n_1\times n_2|}{n_1\cdot n_2}$ `line-line`
- $\cos\theta=\dfrac{|A_1A_2+B_1B_2|}{\sqrt{A_1^2+B_1^2}+\sqrt{A_2^2+B_2^2}}$ `line-line`
