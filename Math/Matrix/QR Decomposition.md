...
- $\vec u_1=\vec a_1,\quad \vec q_1=\dfrac{\vec u_1}{||\vec u_1||}$
- $\vec u_2=\vec a_2 -\text{proj}_{\vec q_1} \vec a_2,\quad q_2=\dfrac{\vec u_2}{||\vec u_2||}$ 
...
###### Householder Reflections $H_k=I-2\dfrac{\vec v\vec v^T}{\vec v^T \vec v}$
