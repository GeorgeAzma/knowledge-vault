### $S_L=AA^T$
### $S_R=A^TA$
- [[Eigenvector|eigenvectors]] of $S_L,S_R$ are Left/Right Singular Vectors of $A$
- Square root of [[Eigenvalue|eigenvalues]] of $S_L,S_R$ are Left/Right Singular Values of $A$
If you sort singular values of $S_L,S_R$ by descending order, their values are going to be identical
> [!note] 
