...
- **Symmetric** $\forall a,b\in A,aRb\implies bRa$  `alice.is_sibling(bob) = bob.is_sibling(alice)`
- **Transitive** $\forall a,b,c\in A,aRb\land bRc\implies aRc$ `if a > b and b > c, then a > c`
### Other Relations
- $x\mid y$ `y is divisible by x. x divides y`
