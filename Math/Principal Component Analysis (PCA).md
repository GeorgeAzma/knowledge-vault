...
# Assume we have a dataset X with n samples and m features
...
> $p_n=(x, 2x)$
> > [!note] You'd have to remove that dimension every time you input data in NN

> [!example]
> If 2D points $p_i=(x,y)$ follow some linear pattern
> like $y=2x+noise$ then you can remove $y$ dimension
