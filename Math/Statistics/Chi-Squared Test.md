...
> $\chi^2(45.71,2)=\dfrac{45.71^{\dfrac{2}{2}-1}e^{-\dfrac{45.71}{2}}}{2^\dfrac{2}{2}\Gamma(\dfrac{2}{2})}=\dfrac{e^{-22.86}}{2}=5.9\times10^{-11}$
...
- $o$ observed
- $e$ expected
### Chi-Distribution $\chi^2(x,k)=\dfrac{x^{\dfrac{k}{2}-1}e^{-\dfrac{x}{2}}}{2^\dfrac{k}{2}\Gamma(\dfrac{k}{2})}$
...
### [[Cumulative Distribution Function|CDF]] $\int_{\chi^2}^\infty\chi^2(x,k)dx=\dfrac{\gamma(\dfrac{k}{2},\dfrac{x}{2})}{\Gamma(\dfrac{k}{2})}$
gives [[p-value]]
- $\lambda$ [[Gamma Function#Incomplete Gamma Function $ gamma(x,b)= int_0 b t {x-1}e {-t} dt$|Incomplete Gamma Function]]
