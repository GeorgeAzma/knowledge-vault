...
'saturation' mix(vec3(dot(col, vec3(0.2126, 0.7152, 0.0722))), col, 1.0 + saturation)
  'vibrance' mix(col, vec3(avg), (dot(col, vec3(1.0 / 3.0)) - max(col.r, max(col.g, col.b))) * vibrance)
