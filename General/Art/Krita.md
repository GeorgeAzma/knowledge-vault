...
- `Ctrl+U` HSV adjust
- `Alt+0,9` quick change brush `rebound Ctrl+Alt+0,9`
- `Alt+~` change quick brush preset
- `Ctrl+F` freehand selection `rebound`
### Tutorials
...
- remove whitespace on top of `Wide Gamut Selector`, along fg/bg switcher
- sensor curves similar to shader graph, sometimes I want curves to depend on each other or have some complex relationship, krita's sensor curves aren't advanced enough for this
