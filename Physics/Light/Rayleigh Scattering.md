...
- $\eta\approx1.000293$ Index of refraction of [[Air]]
- $N$ Molecular density at sea level
- $\lambda$ Wave length
- $h$ Altitude
- $H_R$ Height scale `8km`
### Precomputed $\frac{8\pi^3(\eta^2-1)^2}{3N\lambda^4}$
- Blue $440\text{ nm}$ $33.1\times10^{-6}m^{-1}$
- Green $550\text{ nm}$ $13.5\times10^{-6}m^{-1}$
- Red $680\text{ nm}$ $5.8\times10^{-6}m^{-1}$
**QD-OLED `gen-3` Peak Wavelengths**
- Blue $453\text{ nm}$
- Green $528\text{ nm}$
- Red $631\text {nm}$ 
