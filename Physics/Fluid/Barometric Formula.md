...
### $P=P_0(1-\dfrac{Lh}{T_0})^\dfrac{gM}{R^*L}$
...
### Precalculated For Air $P=101325(1-\dfrac{0.0065h}{T_0})^{5.25578}$
> [!example] density of `15C` air at `1400m` elevation
> $P=101325(1-\dfrac{0.0065\cdot 1400}{288.15})^{5.2557813}\approx85600\text{ Pa}$
> $R=\dfrac{R^*}{M}=\dfrac{8.31446}{0.0289644}\approx287$ [[Specific Gas Constant]]
> $\rho=\dfrac{P}{RT}=\dfrac{85600}{287\cdot288.15}\approx1.035\text{ kg/m}^3$ [[Ideal Gas Law]]
