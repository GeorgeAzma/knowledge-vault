...
| `echo`  |                  print                  |                                                                                |                                                     `echo 'hi' > foo.txt`                                                      |
| `touch` |               create file               |                                                                                |                                                        `touch foo.txt`                                                         |
| `wget`  |              web download               |                                  `-r` recurse                                  |                                                   `http://foo.com/file.txt`                                                    |
| `curl`  |            get/post web data            |                               `-O` download file                               |                                           `-X POST -d "name=foo" http://foo.com/api`                                           |
