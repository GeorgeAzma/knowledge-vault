...
aliases:
  - Message Digest
---
- Converts variable size input into fixed size hash that can't be converted back into original input
...
- md5 `insecure, slow`
> [!tip] 
> Hash can be used for fast [[Transport Layer Security#Purpose|Authentication And Integrity]], see [[Message Authentication Code]] for more info
