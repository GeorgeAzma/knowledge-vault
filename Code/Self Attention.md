...
- That will get you $k,q,v$ matrices
	- Do dot product of 1st input's query vector and it's key vector to get the score for 1st input and optionally divide the score by $\sqrt{d_{k}}$ 
	- Do dot product of 1st input's query vector and 2nd input's key vector to get the score for 2nd vector and optionally divide the score by $\sqrt{d_{k}}$ 
