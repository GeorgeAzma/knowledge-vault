...
upscaling it using [[Convolutional Neural Network|ConvTranspose2D]] layers, which also applies
...
> [!note]
> Discriminator uses [[Convolutional Neural Network|Conv2D]] for detecting features in the image to help differentiate real images from fake ones
### Code
- Linear GAN
```Python
import torch
